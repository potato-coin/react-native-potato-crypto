...
jobjectArray Java_com_reactlibrary_PotatoCryptoModule_bip39GetLanguages(JNIEnv *env, jclass) {
...
jobjectArray Java_com_reactlibrary_PotatoCryptoModule_bip39GetWordsFromLanguage(
...
jboolean Java_com_reactlibrary_PotatoCryptoModule_bip39ValidateMnemonic(
    JNIEnv *env,
    jclass,
    jstring mnemonic_,
    jstring language_) {
...
jobject Java_com_reactlibrary_PotatoCryptoModule_bip39EncodeBytes(
    ...
    jclass mrClass = env->FindClass("com/reactlibrary/MnemonicResult");
...
jobject Java_com_reactlibrary_PotatoCryptoModule_bip39Generate(
    JNIEnv *env,
    jclass type,
    jstring language_,
    jint entropy) {
...
jbyteArray Java_com_reactlibrary_PotatoCryptoModule_bip39WordsToSeed(
...
jstring Java_com_reactlibrary_PotatoCryptoModule_bip39WordsToSeedHex(
        JNIEnv *env, jclass, jstring mnemonic_) {
    const char *mnemonic = env->GetStringUTFChars(mnemonic_, 0);
    ...
    jstring out = env->NewStringUTF(hex.c_str());
